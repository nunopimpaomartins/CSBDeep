...
def conv_block2(n_filter, n1, n2,
    ...
    def _func(lay):
        if batch_norm:
            s = Conv2D(n_filter, (n1, n2), padding=border_mode, use_bias=use_bias, kernel_initializer=init, **kwargs)(lay)
            s = BatchNormalization()(s)
            s = Activation(activation)(s)
        else:
            s = Conv2D(n_filter, (n1, n2), padding=border_mode, use_bias=use_bias, kernel_initializer=init, activation=activation, **kwargs)(lay)
